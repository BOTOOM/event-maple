				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-4xl mx-auto">
					{benefits.map((benefit) => {
						...
						return (
							<div
								key={benefit.id}
								className="flex flex-col items-center text-center p-8 rounded-lg hover:shadow-lg transition-shadow bg-card"
							>
								<div className="w-16 h-16 bg-winter-100 rounded-full flex items-center justify-center mb-6">
