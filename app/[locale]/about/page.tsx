		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-5xl">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">{t("header.subtitle")}</p>
				</div>
				...
				<div className="bg-gradient-to-br from-primary/5 to-blue-50 rounded-2xl shadow-lg border border-primary/10 p-8 md:p-12 mb-8">
					<div className="flex items-center gap-3 mb-8">
						...
						<h2 className="text-3xl font-bold text-gray-900">{t("offer.title")}</h2>
					</div>
							...
							<ul className="space-y-3">
								{[0, 1, 2, 3].map((i) => (
									<li key={i} className="flex items-start gap-2">
										...
										<span className="text-gray-700">{t(`offer.organizers.items.${i}`)}</span>
									</li>
								))}
							</ul>
						</div>
						...
						<div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
							...
							<ul className="space-y-3">
								{[0, 1, 2, 3].map((i) => (
									<li key={i} className="flex items-start gap-2">
										<CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
										<span className="text-gray-700">{t(`offer.attendees.items.${i}`)}</span>
									</li>
								))}
							</ul>
						</div>
				...
				<div className="bg-gray-900 text-white rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
					...
					<div className="grid md:grid-cols-3 gap-6">
						<div className="text-center">
							...
							<p className="text-gray-300 text-sm">{t("values.community.desc")}</p>
						</div>
						<div className="text-center">
							...
							<p className="text-gray-300 text-sm">{t("values.simplicity.desc")}</p>
						</div>
						<div className="text-center">
							...
							<p className="text-gray-300 text-sm">{t("values.free.desc")}</p>
						</div>
					</div>
				</div>
