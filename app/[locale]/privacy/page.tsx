...
import { Eye, Lock, Mail, Server, Shield, UserCheck } from "lucide-react";
								...
								{[0, 1, 2].map((i) => (
									<li
										...
										dangerouslySetInnerHTML={{
											__html: t.raw(`sections.collection.account.items.${i}`),
										}}
									/>
								))}
							</ul>
							...
							<ul className="list-disc pl-6 space-y-2">
								{[0, 1, 2, 3].map((i) => (
									<li
										key={i}
										dangerouslySetInnerHTML={{
											__html: t.raw(`sections.collection.usage.items.${i}`),
										}}
									/>
								))}
							</ul>
							...
							<ul className="list-disc pl-6 space-y-2">
								{[0, 1].map((i) => (
									<li
										key={i}
										dangerouslySetInnerHTML={{
											__html: t.raw(`sections.collection.technical.items.${i}`),
										}}
									/>
								))}
							</ul>
				...
				<div className="space-y-3 text-foreground/80 leading-relaxed">
					...
					<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
						<p
							...
							dangerouslySetInnerHTML={{ __html: t.raw("sections.usage.commitment") }}
						/>
					</div>
				</div>
			</section>
			...
			<section>
				...
				<div className="space-y-3 text-foreground/80 leading-relaxed">
					...
					<FeatureList
						items={[
							{
								title: t("sections.storage.encryption.title"),
								description: t("sections.storage.encryption.text"),
							},
							{
								title: t("sections.storage.infrastructure.title"),
								description: t("sections.storage.infrastructure.text"),
							},
							{
								title: t("sections.storage.access.title"),
								description: t("sections.storage.access.text"),
							},
							{
								title: t("sections.storage.minimization.title"),
								description: t("sections.storage.minimization.text"),
							},
						]}
						className="mt-4"
					/>
				...
				<div className="space-y-3 text-foreground/80 leading-relaxed">
					...
					<ul className="list-disc pl-6 space-y-2">
						{[0, 1, 2].map((i) => (
							<li
								key={i}
								dangerouslySetInnerHTML={{ __html: t.raw(`sections.sharing.items.${i}`) }}
							/>
						))}
					</ul>
					<div className="bg-red-50 border border-red-200 rounded-lg p-4 mt-4">
						<p
							...
							dangerouslySetInnerHTML={{ __html: t.raw("sections.sharing.guarantee") }}
						/>
					</div>
				</div>
			</section>
				...
				<div className="space-y-3 text-foreground/80 leading-relaxed">
					...
					<ul className="list-disc pl-6 space-y-2">
						{[0, 1, 2].map((i) => (
							<li
								key={i}
								dangerouslySetInnerHTML={{ __html: t.raw(`sections.retention.items.${i}`) }}
							/>
						))}
					</ul>
				</div>
				...
				<div className="space-y-3 text-foreground/80 leading-relaxed">
					...
					<RightsGrid
						items={[
							...
							{
								title: t("sections.rights.rectification.title"),
								description: t("sections.rights.rectification.desc"),
							},
							{
								title: t("sections.rights.deletion.title"),
								description: t("sections.rights.deletion.desc"),
							},
							{
								title: t("sections.rights.portability.title"),
								description: t("sections.rights.portability.desc"),
							},
						]}
						className="mt-4"
					/>
				...
				<div className="space-y-3 text-foreground/80 leading-relaxed">
					...
					<ul className="list-disc pl-6 space-y-2">
						{[0, 1].map((i) => (
							<li
								key={i}
								dangerouslySetInnerHTML={{ __html: t.raw(`sections.cookies.items.${i}`) }}
							/>
						))}
					</ul>
