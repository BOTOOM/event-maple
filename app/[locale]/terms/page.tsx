  ...
  return (
    ...
    >
      ...
      <LegalSection title={t("sections.data.title")}>
        ...
        <LegalList 
          items={[0, 1, 2].map(i => t.raw(`sections.data.items.${i}`))} 
          useHtml 
        />
        ...
        <p className="mt-4" dangerouslySetInnerHTML={{ 
          __html: t.raw("sections.data.privacyLink")
            .replace('<link>', '<a href="/privacy" class="text-primary hover:underline font-medium">')
            .replace('</link>', '</a>') 
        }} />
      </LegalSection>
