...
test.describe('Authenticated User Features', () => {
  ...
  test.describe('Favorites', () => {
    ...
    test('should toggle event favorites', async ({ page }) => {
      ...
      const favoriteButton = page.locator('button').filter({ hasText: /favorites|favoritos/i }).first();
  ...
  test.describe('My Personal Agenda', () => {
    ...
    test('should navigate between full agenda and my agenda tabs', async ({ page }) => {
      ...
      const fullAgendaTab = page.locator('a:has-text("Full Agenda"), button:has-text("Full Agenda")').first();
      await fullAgendaTab.click();
      
      await expect(page).toHaveURL(/\/agenda/);
      
      // Click on My Agenda tab
      const myAgendaTab = page.locator('a:has-text("My Agenda"), button:has-text("My Agenda")').first();
  ...
  test.describe('Talk Detail (Authenticated)', () => {
    ...
    test('should add talk to my agenda', async ({ page }) => {
      ...
      const addButton = page.locator('button:has-text("Add to my agenda"), button:has-text("Añadir a mi agenda")');
      ...
      if (await addButton.isVisible()) {
        ...
        const inAgendaButton = page.locator('button:has-text("In my agenda"), button:has-text("En mi agenda")');
    ...
    test('should display difficulty level if available', async ({ page }) => {
      ...
      const difficulty = page.locator('text=Intermedio, text=Intermediate, text=Básico, text=Basic, text=Avanzado, text=Advanced');
  ...
  test.describe('Full Agenda (Authenticated)', () => {
    ...
    test('should add talk to agenda from full agenda view', async ({ page }) => {
      ...
      const addButton = page.locator('button:has-text("Add to agenda"), button[aria-label*="agenda"]').first();
