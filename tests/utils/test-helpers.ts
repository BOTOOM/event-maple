 ...
 */
export async function navigateToLocalized(page: Page, locale: Locale, path: string = ''): Promise<void> {
...
export function getMyAgendaButton(page: Page) {
  return page.locator(
    'a:has-text("My Personal Agenda"), a:has-text("My Agenda"), a:has-text("Mi Agenda")'
  ).first();
}
